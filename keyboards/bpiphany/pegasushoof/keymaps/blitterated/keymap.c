...
#define KM_MISC_N_MEDIA  1
#define KM_QWERTY_WIN    2

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* Layer 0: Standard layer with Mac modifiers */
  [KM_QWERTY_MAC] = LAYOUT( \
    ...
    KC_LCTL,         KC_LALT, KC_LGUI,                            KC_SPC,                                    KC_RGUI, TT(1),   KC_MENU, KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  ...
  [KM_MISC_N_MEDIA] = LAYOUT( \
    ...
    LCTL_T(KC_CAPS), KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______,     _______,   _______,  _______, _______,          KC_PENT,                               \
    _______,         _______, _______, _______, _______, _______, _______, KC__VOLDOWN, KC__VOLUP, KC__MUTE, _______, _______,          _______,             _______,          \
    TG(2),           _______, _______,                            _______,                                   _______, _______, _______, _______,    _______, _______, _______  \
  ),

  /* Layer 2: Windows modifier overlay */
