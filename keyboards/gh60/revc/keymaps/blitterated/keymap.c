...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all( /* 0: qwerty */
        ...
        KC_LCTL,          KC_LALT,   KC_LGUI,                   KC_SPC,                                      KC_RGUI, TT(1),   KC_APP,  KC_RCTL
    ),

    // Poker II Layer 1 layout, Vim movement, Capslock, Layer 1 toggle
    [1] = LAYOUT_all(
        ...
        TG(2),           _______, _______,                   _______,                                     _______, _______, _______, _______
    ),
